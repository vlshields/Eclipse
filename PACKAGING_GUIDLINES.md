...
Fork this repo and download the latest .love archive from the [releases page](https://github.com/vlshields/Eclipse/releases). Clone your fork locally and create a new folder where the build will go. The folder should be
named after the packaging method or distribution you are packaging for. For example, if you are building an Appimage create a folder called "appimage". Likewise, if you are packaging a .deb, create a folder named "debian". 
